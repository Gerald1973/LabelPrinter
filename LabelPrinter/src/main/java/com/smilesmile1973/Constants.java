...
public class Constants {
	public static final float NUMBER_OF_POINTS_BY_CM = 28.3464567f;
	...
	public static final int WDROWHEIGHTEXACTLY = 2;
	// WdRulerStyle Enumeration (Word)
	public static final int WDADJUSTNONE = 0;
	public static final int WDADJUSTPROPORTIONAL = 1;
	public static final int WDADJUSTFIRSTCOLUMN = 2;
	public static final int WDADJUSTSAMEWIDTH = 3;
	// WdLineStyle
	...
	public static final int WDLINESTYLETHICKTHINSMALLGAP = 9;
	...
	// BORDER
	public static final int BORDERTOP = 1;
	public static final int BORDERLEFT = 2;
	public static final int BORDERBOTTOM = 4;
	public static final int BORDERRIGHT = 8;
	public static final int BORDERNWSE = 16;
	public static final int BORDERSWNE = 32;
	// WdPaperSize
